...
class App:
    def __init__(self, master: ctk.CTk):
        ...
        self.rows_label.place(relx=0.3, rely=0.1, anchor="center")
        ...
        slider_rows.place(relx=0.3, rely=0.2, anchor="center")
        ...
        self.balls_drawn_label.place(relx=0.3, rely=0.3, anchor="center")
        ...
        slider_balls_drawn.place(relx=0.3, rely=0.4, anchor="center")
        ...
        self.max_ball_number_label.place(relx=0.3, rely=0.5, anchor="center")
        ...
        slider_max_ball_number.place(relx=0.3, rely=0.6, anchor="center")
        ...
        self.powerball_label.place(relx=0.3, rely=0.7, anchor="center")
        #Create the powerball slider
        slider_powerball = ctk.CTkSlider(self.master, from_=10, to=100, number_of_steps=90, command=self.slider_powerball_event)
        slider_powerball.place(relx=0.3, rely=0.8, anchor="center")
