...
class App:
    def __init__(self, master: ctk.CTk):
        ...
        self.rows_label.place(relx=0.3, rely=0.1, anchor="e")
        ...
        slider_rows.place(relx=0.3, rely=0.2, anchor="e")
        ...
        self.balls_drawn_label.place(relx=0.3, rely=0.3, anchor="e")
        ...
        slider_balls_drawn.place(relx=0.3, rely=0.4, anchor="e")
        ...
        self.max_ball_number_label.place(relx=0.3, rely=0.5, anchor="e")
        ...
        slider_max_ball_number.place(relx=0.3, rely=0.6, anchor="e")
        ...
        self.powerball_label.place(relx=0.3, rely=0.7, anchor="e")
        ...
        slider_powerball.place(relx=0.3, rely=0.8, anchor="e")
        ...
        self.button.place(relx=0.3, rely=0.9, anchor="e")

        #create the text box
        self.text_box = ctk.CTkTextbox(self.master, width=400, height=500, font=("Courier", 24))
        self.text_box.place(relx=0.9, rely=0.5, anchor="e")
    ...
    def populate_box(self):
        ...
        final_lines = newlotto.get_lines(int(self.row_number),int(self.max_ball_number), int(self.balls_drawn), int(self.powerball))
        for line in final_lines:
            self.text_box.insert("1.0", str(line[0]) + "\n")
        pass
